...
$replacements = [
    'aurion72\\\\chartjs\\\\' => function () use(&$values) { return str_replace('\\', '\\\\', $values['psr4_namespace']) . '\\\\'; },
    'Aurion72'                 => function () use(&$values) { return $values['author_name']; },
    'Aurion72'             => function () use(&$values) { return $values['author_github_username']; },
    'https://www.agence-aurion.fr'              => function () use(&$values) { return $values['author_website'] ?: ('https://github.com/' . $values['author_github_username']); },
    'contact@agence-aurion.fr'                => function () use(&$values) { return $values['author_email'] ?: ($values['author_github_username'] . '@example.com'); },
    'aurion72'                      => function () use(&$values) { return $values['package_vendor']; },
    'chartjs'                => function () use(&$values) { return $values['package_name']; },
